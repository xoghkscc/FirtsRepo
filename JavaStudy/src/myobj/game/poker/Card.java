...
public class Card implements Comparable<Card>{	
	...
	final public static Suit SPADE	 = new Suit(0, 'ㅇ', "�����̵�", "Spade");
	final public static Suit CLOVER	 = new Suit(1, 'ㅁ', "Ŭ�ι�", "Clover");
	final public static Suit HEART	 = new Suit(2, 'ㄹ', "��Ʈ", "Heart");
	final public static Suit DIAMOND = new Suit(3, 'ㅎ', "���̾Ƹ��", "Diamond");
